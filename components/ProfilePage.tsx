...
export default function ProfilePage() {
  ...
  // Desktop submit handler (includes PIN)
  ...
  return (
    <>
      {/* Mobile Layout - Always in edit mode, no PIN */}
      ...
      {/* Desktop Layout - Original with view/edit toggle and PIN */}
      <div className="hidden md:flex min-h-screen bg-gray-50 py-8 px-4 items-center justify-center">
        <div className="max-w-xl w-full">
          ...
          <form onSubmit={handleDesktopSubmit} className="space-y-6">
            <div>

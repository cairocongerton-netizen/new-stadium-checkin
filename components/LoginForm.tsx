          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                maxLength={4}
                className="w-full px-4 py-3 border border-gray-300 focus:outline-none focus:border-black transition-colors text-center text-2xl tracking-[0.5em] text-gray-400"
                placeholder="● ● ● ●"
            ...
            <button
              ...
              className="w-full bg-black text-white px-6 py-4 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors flex items-center justify-center mt-2"
            >
              {isSubmitting ? (
                <>
